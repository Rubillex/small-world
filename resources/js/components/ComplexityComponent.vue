    ...
    <div class="complexety-change">
        <div class="page-content">
            ...
            <div class="content-header__text-wrapper">
                <p class="content-header__text">Выбирая себе компаньона помни, что от него напрямую зависит сложность
        ...
        <div class="rules">
            <div class="rules__wrapper">
                ...
                <div class="rules__text-wrapper">
                    <p class="rules__text">Твоя главная задача набрать как можно больше баллов. Их&nbsp;можно заработать
                    ...
                    <p class="rules__text">Чтобы заработать больше баллов выбирай более высокую сложность. Однако, чем
...
export default {
    ...
    methods: {
        async goProfile() {
            ...
            this.$emit('complexety-changed', this.userDifficult);
            this.$router.go(0)
        },
